...
export function HowItWorksPage() {
  ...
  const limits = t("how.limits", { returnObjects: true }) as string[];
  return (
    <div className="portal mx-auto max-w-3xl px-4 py-12">
      <h1 className="font-display text-5xl">{t("how.title")}</h1>
      ...
      <section className="mt-10">
        <h2 className="font-display text-3xl">{t("how.limitsTitle")}</h2>
